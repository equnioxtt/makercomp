...
// "-latest" alias tracks Google's current recommended flash model instead
// of a pinned version string, which avoids repeating the 404 we hit when
// gemini-2.0-flash was retired (see ERRORS.md).
